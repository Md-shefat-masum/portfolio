        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Update Blood Donner</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">admin</a></li>
                        <li class="breadcrumb-item">blood donner list</li>
                        <li class="breadcrumb-item active">update donner</li>
                    </ol>
                </div>
                <div class="">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-8 m-auto">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Update Donner Information</h4>
                                {{-- <h6 class="card-subtitle">Use Bootstrap's predefined grid classes for horizontal form</h6> --}}
                                <form class="form-horizontal p-t-20" novalidate method="POST" action="{{route('update_donner',$donner->slug)}}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group controls">
                                                ...
                                                <input name="name" value="{{$donner->name}}" type="text" class="form-control" id="exampleInputuname3" required data-validation-required-message="This field is required" placeholder="Donner Name">
                                            </div>
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group controls">
                                                ...
                                                <select name="blood_group" class="form-control custom-select" required data-validation-required-message="This field is required">
                                                    <option>{{$donner->blood_group}}</option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group controls">
                                                ...
                                                <input value="{{$donner->mobile_no}}" name="mobile_no" type="text" class="form-control" id="exampleInputuname3" required data-validation-required-message="This field is required" placeholder="Mobile NO">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group controls">
                                                ...
                                                <input value="{{$donner->email}}" name="email" type="email" class="form-control" id="exampleInputEmail3" required data-validation-required-message="This field is required" placeholder="Enter email">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                ...
                                                <input value="{{$donner->address}}" name="address" type="text" class="form-control" id="exampleInputuname3" placeholder="Present address">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group controls">
                                                ...
                                                <input value="{{$donner->fb_address}}" name="fb_address" type="text" class="form-control" id="exampleInputuname3" required data-validation-required-message="This field is required" placeholder="fb address">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group controls">
                                                ...
                                                <input value="{{$donner->skype}}" name="skype" type="text" class="form-control" id="exampleInputuname3" placeholder="skype">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group controls">
                                                ...
                                                <input value="{{$donner->linkedin}}" name="linkedin" type="text" class="form-control" id="exampleInputuname3" placeholder="linkedin address">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group controls">
                                                ...
                                                <input value="{{$donner->twitter}}" name="twitter" type="text" class="form-control" id="exampleInputuname3" placeholder="twitter address">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                ...
                                                <input value="{{$donner->website}}" name="website" type="text" class="form-control" id="web" placeholder="Enter Website Name">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                ...
                                                <input value="{{$donner->birth_date}}" name="birth_date" type="date" class="form-control" id="web" placeholder="Birth Date" value="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="ti-calendar"></i></div>
                                                <input value="{{$donner->last_donnet}}" name="last_donnet" type="date" class="form-control" id="web" placeholder="last donnet" value="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <img style="width:100px;" class="m-auto img-fluid" src="{{asset('uploads/blood-donner')}}/{{$donner->donner_image}}" alt="{{$donner->donner_image}}">
                                        </div>
                                    </div>
                                    <div class="form-group row m-b-0">
                                        <div class="offset-sm-3 col-sm-9">
                                            <button type="submit" class="btn btn-info waves-effect waves-light m-auto">Update Donner</button>
                                        </div>
                                    </div>
                                </form>
                            </div>

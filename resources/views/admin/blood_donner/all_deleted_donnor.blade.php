...
<div class="page-wrapper">
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor">Blood Donner Recyclebin</h3>
        </div>
    ...
    <table id="dt-example" class="table table-bordered text-center" cellspacing="0" width="100%">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    @php
                        $select=App\blood_donner::where('donner_status',1)->firstOrFail();
            ...
            <td>
                ...
                <a href="{{route('recycle_donner',$data->slug)}}" title="restore user information"><i class="ti-back-left"></i></a>
                <a href="{{route('hard_delete',$data->slug)}}" title="delete user information"><i class="ti-trash"></i></a>
            </td>
        </tr>
        @endforeach

...
Route::get('/blog/blog-details', 'blogController@blog_details')->name('blog_details');
Route::get('/blog/all-blog', 'blogController@all_blog')->name('all_blog');
Route::get('/blog/search', 'blogController@search')->name('blog_search');
